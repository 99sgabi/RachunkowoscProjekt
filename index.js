...
function nowyWiersz(row, lp)
{
    ...
    wartPocz.innerHTML = row.wartoscPoczatkowa.toFixed(2);
    ...
    podstNalA.innerHTML = row.podstawaNaliczaniaAmortyzacji.toFixed(2);
    let stawkaA = newRow.insertCell();
    stawkaA.innerHTML = row.stawkaAmortyzacyjna.toFixed(4);
